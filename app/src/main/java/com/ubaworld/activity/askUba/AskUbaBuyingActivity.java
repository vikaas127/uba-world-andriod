...
public class AskUbaBuyingActivity extends AppCompatActivity implements AdapterCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ask_uba_buying);
    ...
    private void getComment(int i) {
        ...
        if (i == 1)
            call = apiService.list_Comment(2, "id", 1);
        else if (i == 2)
            call = apiService.list_Comment(2, "likes", 1);
        else
            call = apiService.list_CommentMy(2, user_id, 1);
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                try {
                    if (response.isSuccessful()) {
                        ...
                        LogUtils.e("SIZE", "BUYING COMMENT LIST ---> " + data.data.dataItems.size() + logLine());
                        ...
                        if (data != null) {
                            ...
                            rcv_Comment.setLayoutManager(new GridLayoutManager(AskUbaBuyingActivity.this, 1));
                            CommentAdapter adapter = new CommentAdapter(AskUbaBuyingActivity.this, data,2);
                        ...
                        try {
                            ...
                            if (jsonObject.has("message")) {
                                showValidationAlertDialog_withIntent(AskUbaBuyingActivity.this, jsonObject.get("message").toString(), SignInActivity.class);
                            }
                        } catch (Exception e) {
                            showValidationAlertDialog(AskUbaBuyingActivity.this, getString(R.string.server_error_something_went_wrong));
                        }
                    } else {
                        try {
                            String str = response.errorBody().string();
                            JSONObject jsonObject = new JSONObject(str);
                            if (jsonObject.has("message")) {
                                showValidationError(AskUbaBuyingActivity.this, jsonObject.get("message").toString());
                            }
                        } catch (Exception e) {
                            showValidationAlertDialog(AskUbaBuyingActivity.this, getString(R.string.server_error_something_went_wrong));
                        }
    ...
    private void readNotification() {
        ...
        ApiService apiService = RetroFitWebService.generateServiceWithToken(ApiService.class, authToken);
        Call<ResponseBody> call = apiService.read_Notification(user_id, 2);
    ...
    private void addComment() {
        ...
        ApiService apiService = RetroFitWebService.generateServiceWithToken(ApiService.class, authToken);
        Call<ResponseBody> call = apiService.add_Comment(et_Comment.getText().toString(), 2);
